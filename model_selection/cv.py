...
def balance_k_fold_regressor2(train_x, train_y, test_x, model_num, cv=5):
...
def balance_k_fold_regressor(train_x, train_y, test_x, model_num, cv=5):
    ...
    for i in range(cv):
        ...
        kf_normal_X = normal.iloc[normal_train_index[i][1], :-1]
        kf_normal_y = normal.iloc[normal_train_index[i][1], -1]
